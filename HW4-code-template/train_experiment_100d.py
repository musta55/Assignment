#!/usr/bin/env python
# coding: utf-8
'''Experiment: sentiment analysis with embedding_dim=100'''
...
def main():
    ...
    n_layers = 2
    input_len = 150
    embedding_dim = 100  # <<< EXPERIMENT: 100d embeddings
    hidden_dim = 128
    output_size = 1
    num_epoches = 15
    learning_rate = 0.002
    clip = 5
    load_cpt = False
    ckp_path = 'cpt/sentiment_model_100d.pt'
    pretrain = True
    glove_file = 'Glove-embedding/glove.6B.100d.txt'  # <<< 100d GloVe
    ...
    ## Training
    print('='*89)
    print('EXPERIMENT: embedding_dim=100, hidden_dim=128, n_layers=2')
    print('='*89)
    ...
    ## Testing
    print("\n" + "="*70)
    print("TESTING MODEL (embedding_dim=100)")
    print("="*70)
    model.eval()
    ...
    with open('results_100d.json', 'w') as f:
    ...
    print(f"\nResults saved to: results_100d.json")
